                    ...
                    {details.map((detail) => {
                        ...
                        return (
                            <CardElement 
                                ...
                                className="card-base bg-white p-6 flex items-center gap-6 shadow-sm hover:shadow-md transition-shadow group cursor-pointer decoration-transparent select-text"
                            >
                                <div className={`${detail.color} w-10 h-10 rounded-lg flex items-center justify-center text-white flex-shrink-0 group-hover:scale-105 transition-transform`}>
                                    {detail.icon}
                                </div>
